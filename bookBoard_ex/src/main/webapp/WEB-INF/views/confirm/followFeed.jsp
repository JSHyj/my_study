...
<div class="row" style="background-color: #eee;">
	<div class="col-lg-12">
		<div style="margin-top:60px;">
			...
			<li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="font-size: 1.5em;">
                    <span style="color: black">팔로워</span>
                       <i class="fa fa-caret-down"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="/board/login_page">좋아요</a>
                        </li>
                        <li><a href="/board/join_page">웃겨요</a>
                        </li>
                        <li><a href="/board/join_page">슬퍼요</a>
                        </li>
                        <li class="divider"></li>
                      </ul>
                        </li>
...
<div class="container-fluid row" style="margin-top: 20px;">
            ...
            <c:forEach items="${BoardRealVO}" var="board">
            	<c:forEach items="${FollowVO}" var="follow">
				<c:choose>
					<c:when test="${board.user_id eq follow.following}" >
                <div class="col-lg-3">
            ...
            <c:otherwise>
            	${board.user_id } , ${follow.following }
            </c:otherwise>
        </c:choose>
            </c:forEach>
            </c:forEach>
