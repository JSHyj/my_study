...
<body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="" style="margin-bottom: 0; border-radius: 10px 10px 0px 0px; background-color:#4374D9;"> <!-- #4374D9 -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    <span style="color: white;">로그인 또는 회원가입</span>
                        <i class="fa fa-user fa-fw" style="color: white;"></i> <i class="fa fa-caret-down" style="color: white;"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="/board/login_page"><i class="fa fa-user fa-fw"></i>로그인</a>
                        </li>
                        <li><a href="/board/join_page"><i class="fa fa-edit fa-fw"></i>회원가입</a>
                        </li>
                        <li class="divider"></li>
                        </li>
                    </ul>
