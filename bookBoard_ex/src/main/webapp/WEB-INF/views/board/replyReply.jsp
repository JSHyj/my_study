...
<div class="modal fade" id="modifyReply" tabindex="-1" role="dialog" aria-labelledby="modifyReplyLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form role="form" role="form" action="/board/replyReply.do" method="post">
					<input type="text" name="rno" value="${reReply.rno}">
					<input type="text" name="bno" value="${reReply.bno}">
					<input type="text" name="user_id" value="${reReply.user_id}">
					<input type="text" name="step" value="${reReply.step}">
					<input type="text" name="indent" value="${reReply.indent}">
					<input type="text" name="del" value="${reReply.del}">
					<input type="text" name="user_img" value="${reReply.user_img}">
