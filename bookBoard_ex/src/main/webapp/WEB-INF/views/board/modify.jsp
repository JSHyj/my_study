...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header" style="50px"></h1>
	</div>
			...
			<div class="panel-body">
				<form role="form"  action="/board/modify" method="post">
					...
					<input type="hidden" name="bno" value="<c:out value="${board.bno}" />">
						<label>제목</label><input class="form-control" name="title" value="<c:out value="${board.title}" />" required>
					</div>
					...
					<button type="button" data-oper='modify' class="btn btn-primary">수정완료</button>
					<button type="button" data-oper='cancel' class="btn btn-default">취소하기</button>
					...
					$(document).ready(function() {
						...
						$('button').on("click",function(e) {
							...
							if(operation === 'modify'){
								...
								self.location ="/board/list?page=1";
								return;
							}
						...
						$.getJSON("/board/getAttachList", {bno: bno}, function(arr) {
							...
							$(arr).each(function(i, attach) {
								...
								if(attach.fileType) {
									...
									str += "<input type='radio' name='main_img' value='"+fileCallPath+"' checked/>메인이미지로 설정";
									str += "</div>";
									str += "</li>";
								}else {
									str += "<li data-path='"+attach.uploadPath+"' data-uuid='"+attach.uuid+"' data-filename='"+attach.fileName+"' data-type='"+attach.fileType+"' ><div>";
